                        ...
                        <form method="post" action="{{route('store.jop')}}">
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-10 mb-3">
                                    ...
                                    <input type="text" name="nik_name" value="{{old('nik_name')}}" class="form-control"  placeholder="@lang('app.acronym')" value="">
                                </div>

                                <div class="col-md-10 mb-3">
                                    <label>@lang('app.The job is in English')</label>
                                    <input type="text" name="name_en" value="{{old('name_en')}}" class="form-control"  placeholder="@lang('app.The job is in English')" value="">
                                </div>

                                <div class="col-md-10 mb-3">
                                    <label>@lang('app.The job is in Arabic')</label>
                                    <input type="text" name="name_ar" value="{{old('name_ar')}}" class="form-control"  placeholder="@lang('app.The job is in Arabic')" value="">
                                </div>
