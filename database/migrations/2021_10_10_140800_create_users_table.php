...
class CreateUsersTable extends Migration
{
    ...
    public function up()
    {
        ...
        DB::table('users')->insert([
            ...
            //
            ['name'=>'Mohmed Abrahaim Alsyed','email'=>'mohmed_abrahiem@gamil.com','password'=>'$2y$10$CvNMruPNAv02ZM05iCPp7OGgOYDInzczf706HACP1NaAvHfv6zVpG','employee_id'=>4,'permissions_array'=>json_encode([]),'as'=>"ONTHER"],
            ['name'=>'Ali Osman Mostafa','email'=>'ali2020@gamil.com','password'=>'$2y$10$CvNMruPNAv02ZM05iCPp7OGgOYDInzczf706HACP1NaAvHfv6zVpG','employee_id'=>5,'permissions_array'=>json_encode([]),'as'=>"ONTHER"],
